...
proc create_root_design { parentCell } {
  ...
  # Create instance: parallella_mio_0, and set properties
  set parallella_mio_0 [ create_bd_cell -type ip -vlnv www.parallella.org:user:parallella_mio:1.0 parallella_mio_0 ]
...
CONFIG.PCW_I2C0_RESET_ENABLE {0} CONFIG.PCW_IRQ_F2P_INTR {0} \
...
CONFIG.PCW_USE_S_AXI_HP0 {1}  ] $processing_system7_0
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins parallella_mio_0/s_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net parallella_mio_0_gpio_n [get_bd_ports gpio_n] [get_bd_pins parallella_mio_0/gpio_n]
  connect_bd_net -net parallella_mio_0_gpio_p [get_bd_ports gpio_p] [get_bd_pins parallella_mio_0/gpio_p]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins parallella_mio_0/s_axi_aresetn] [get_bd_pins parallella_mio_0/sys_nreset] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins parallella_mio_0/sys_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]

  # Create address segments
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs parallella_mio_0/s_axi/axi_lite] SEG_parallella_mio_0_axi_lite
